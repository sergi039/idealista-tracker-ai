...
TRANSLATIONS = {
    "en": {
        ...
        "recommendation_profile_dirty": "Recommendations are being refreshed after your latest feedback.",
    ...
    "es": {
        ...
        "recommendation_profile_dirty": "Las recomendaciones se están actualizando tras sus últimos comentarios.",
