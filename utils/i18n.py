...
TRANSLATIONS = {
    "en": {
        ...
        "similar_coverage_tooltip": "A weighted likeness, on the facts both listings state — price, built area, location, plot, bedrooms, bathrooms, distance to the sea, sea view — to the nearest favorite of the same subscription. The favorites themselves are always shown. A listing that cannot be placed on the map is never counted as similar.",
        ...
        "similarity_basis_locality": "the locality centroid (approximate coordinate)",
    ...
    "es": {
        ...
        "similar_coverage_tooltip": "Un parecido ponderado, sobre los datos que ambos anuncios indican — precio, superficie construida, ubicación, parcela, dormitorios, baños, distancia al mar, vistas al mar — con el favorito más cercano de la misma suscripción. Los favoritos siempre se muestran. Un anuncio que no se puede situar en el mapa nunca cuenta como parecido.",
        ...
        "similarity_basis_locality": "el centroide de la localidad (coordenada aproximada)",
