...
TRANSLATIONS = {
    "en": {
        ...
        "hazards_coverage": "Industrial neighbours: %s of %s listings scanned",
        "hazards_coverage_tooltip": "The rest were never scanned. A listing with no scan is not a listing with nothing near it.",
    ...
    "es": {
        ...
        "hazards_coverage": "Vecindad industrial: %s de %s anuncios explorados",
        "hazards_coverage_tooltip": "El resto nunca se exploró. Un anuncio sin exploración no es un anuncio sin nada cerca.",
