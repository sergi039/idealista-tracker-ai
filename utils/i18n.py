...
TRANSLATIONS = {
    "en": {
        ...
        "photos_captured_one": "%s photo",
        "photos_captured_other": "%s photos",
        "photos_captured_tooltip": "Photographs the portal published, captured at ingest and served from the portal's own CDN. One that has been taken down says so in its place.",
        "photos_unknown": "Photos not captured",
        "photos_column_title": "The listing's own first photograph",
        "photo_gone": "photo gone",
        ...
        "criteria_filter": "Subscription criteria",
        "criteria_default": "Criteria: matching + unmeasured",
        "criteria_all": "Criteria: show everything",
        "criteria_pass": "Criteria: matching only",
        "criteria_unknown": "Criteria: unmeasured only",
        "criteria_fail": "Criteria: failing only",
        "taste_sort_dormant": "Taste ranking is being rebuilt — not ordering yet",
        "taste_sort_dormant_tooltip": "The taste profile was rebuilt and the listings have not all been re-scored against it. A score made against an older profile is never ranked beside a current one, so this order falls back to the date until the re-scoring finishes.",
        ...
        "taste_retrain_button": "Retrain taste",
        "taste_retrain_title": "Rebuild the taste profile from your comments and re-score stale listings",
        "taste_retrain_confirm": "Rebuild the taste profile from your comments and re-score the visible listings? Spends subscription credit (roughly 1 call per 8 listings; no Google).",
        "taste_mode_title": "Taste - how well each listing matches the owner's taste",
        "taste_score_label": "Taste",
        "taste_title": "Owner's taste match",
        "taste_not_scored": "Not scored against the taste profile yet.",
        "taste_stale_hint": "Scored against an earlier taste profile; re-run the taste backfill to refresh.",
        "taste_coverage": "Taste: %s of %s scored against profile v%s",
        "taste_coverage_tooltip": "The rest are unscored, or scored against an earlier profile version. An unscored listing is not a listing the owner would dislike.",
        "taste_confidence_label": "Confidence",
        "taste_profile_version_label": "profile",
        "taste_closest_reference": "closest to",
        "recommendation_profile_current": "Recommendations use %s positive references and %s recorded preferences.",
        "recommendation_profile_unapplied": "%s preference(s) are not used yet.",
        "recommendation_hard_exclusions": "%s confirmed hard-rule conflict(s) are hidden from this recommendation view; they remain available in other modes.",
        "recommendation_profile_dirty": "Recommendations need a refresh after your latest feedback.",
        "recommendation_profile_pending": "Recommendations are being prepared from your feedback.",
        "recommendation_profile_failed": "Recommendations could not be refreshed; the previous evidence may be outdated.",
        "recommendation_profile_none": "Star a listing or add a verdict to begin recommendations.",
        "recommendation_refresh_button": "Refresh recommendations",
        "recommendation_refresh_title": "Rebuild recommendation evidence, then rerank prepared listings without per-listing model calls",
        "recommendation_refresh_confirm": "Refresh recommendations from your comments and favorites? Uses up to one subscription profile call; candidate reranking uses no per-listing model calls and no Google.",
        "recommendation_reference": "Reference listing",
        "recommendation_rejected": "Rejected — not recommended",
        "recommendation_candidate": "Candidate",
        "recommendation_stale": "Earlier recommendation",
        "recommendation_no_profile": "No recommendation yet",
        "recommendation_nearest_reference": "Closest positive reference:",
        "recommendation_reference_resemblance": "Also resembles:",
        "recommendation_conflicts_present": "Known conflicts need attention.",
        "recommendation_verification_needed": "Some important details still need checking.",
        "recommendation_mode_title": "Recommendations based on your references and feedback",
        "recommendation_sort_label": "Recommendations",
        "recommendation_column_label": "Match",
        "recommendation_similar_to": "Similar to",
        "recommendation_details": "Details",
        "recommendation_matches": "Matching preferences",
        "recommendation_check_count": "Topics to check: %s",
        "recommendation_conflict_count": "Conflicts: %s",
        "recommendation_photo_count": "Photo similarities: %s",
        "recommendation_aspect_plot_outline": "plot shape",
        "recommendation_aspect_plot_area_m2": "plot size",
        "recommendation_aspect_planning_usability": "legal status and work feasibility",
        "recommendation_aspect_utilities": "utilities",
        "recommendation_aspect_beach_access": "beach access",
        "recommendation_aspect_fiber": "fibre internet",
        "recommendation_aspect_price_value": "price relative to the market",
        "recommendation_aspect_sea_view": "sea view",
        "recommendation_aspect_house_condition": "house condition",
        "recommendation_aspect_area_consistency": "area records",
        "recommendation_aspect_neighbor_privacy": "privacy and neighbours",
        "recommendation_aspect_nearby_buildings": "nearby buildings",
        "recommendation_aspect_agricultural_context": "agricultural surroundings",
        "recommendation_aspect_road_proximity": "road proximity",
        "recommendation_aspect_house_character": "house character",
        "recommendation_aspect_room_scale": "room size",
        "recommendation_aspect_land_presence": "land with the house",
        "recommendation_aspect_visual_appeal": "appearance",
        "recommendation_aspect_property_kind": "property type",
        "recommendation_aspect_budget_condition": "price and readiness condition",
        # Likeness to the subscription's favorites (services/favorite_similarity.py).
        # The cut speaks the chip's own units, so "≥ 70" reads against the
        # "≈ 74" beside the score rather than as an abstract grade.
        "similar_filter": "Similar to the favorites",
        "similar_any": "Similar to ★: any",
        "similar_80": "Similar to ★: ≥ 80",
        "similar_70": "Similar to ★: ≥ 70",
        "similar_60": "Similar to ★: ≥ 60",
        "similarity_sort_label": "Similarity to favorites",
        "similar_coverage": "Similar: %s at ≥ %s to",
        "similarity_references_one": "%s favorite",
        "similarity_references_other": "%s favorites",
        "similarity_references_each": "each subscription's own favorites (%s in all)",
        "similarity_to_favorites_basis": "the favorite's location from",
        "similar_set_aside": "— %s you rejected set aside",
        "similar_hidden_by_favorites": "— hidden by the Favorites switch",
        "similar_rankable": "Similar: %s of %s rankable against",
        "similar_no_reference_hint": "This subscription has no favorites yet, so this cut keeps nothing",
        "similarity_counts_line": "%s cannot be placed · %s of a different kind · %s with no favorite to compare to · %s you rejected · %s of the rankable rest on price, area and location alone · plot compared on %s.",
        "similarity_facts_short": "%s of %s facts",
        "similar_coverage_tooltip": "A weighted likeness, on the facts both listings state — price, built area, location, plot, bedrooms, bathrooms, distance to the sea, sea view — to the nearest favorite of the same subscription. The favorites themselves are always kept by the cut. A listing that cannot be placed on the map is never counted as similar.",
        "similarity_chip_title": "Similarity %s to favorite #%s, on: %s",
        "similarity_thin_hint": "Not ranked: this listing cannot be placed (no coordinate, and no located listing in its municipality), so the number rests on %s alone",
        "similarity_title": "Similar to the favorites",
        "similarity_reference": "This listing is one of the subscription's favorites; the others are measured against it.",
        "similarity_nearest": "nearest favorite",
        "similarity_compared_on": "compared on",
        "similarity_location_basis": "location from",
        "similarity_basis_coordinate": "the listing's own coordinate",
        "similarity_basis_approximate": "the listing's approximate coordinate (a pin or a locality centroid)",
        "similarity_basis_municipality": "the municipality's located listings",
        "similarity_basis_municipality_n": "the municipality's located listings (%s)",
        "similarity_not_ranked_thin": "Not ranked: the listing cannot be placed on the map, and a likeness needs a location.",
        "similarity_different_kind": "Not compared: a different kind of listing from the subscription's favorites.",
        "similarity_no_reference": "Nothing to compare against: this subscription has no favorites yet.",
        "similarity_rejected": "You rejected this listing, so it is left out of the similar selection — the score below is what it would have scored.",
        "similarity_nothing_compared": "Nothing to compare: the listing and the favorites state no fact in common.",
        "similarity_see_list": "Show the listings most similar to the favorites",
        "similarity_component_price": "price",
        "similarity_component_area": "built area",
        "similarity_component_geography": "location",
        "similarity_component_plot": "plot",
        "similarity_component_bedrooms": "bedrooms",
        "similarity_component_bathrooms": "bathrooms",
        "similarity_component_sea_distance": "distance to the sea",
        "similarity_component_sea_view": "sea view",
    ...
    "es": {
        ...
        "photos_captured_one": "%s foto",
        "photos_captured_other": "%s fotos",
        "photos_captured_tooltip": "Fotografías publicadas por el portal, capturadas al importar y servidas desde el CDN del propio portal. Si alguna ha sido retirada, se indica en su lugar.",
        "photos_unknown": "Fotos no capturadas",
        "photos_column_title": "La primera fotografía del anuncio",
        "photo_gone": "foto no disponible",
        ...
        "criteria_filter": "Criterios de la suscripción",
        "criteria_default": "Criterios: cumplen + sin medir",
        "criteria_all": "Criterios: mostrar todo",
        ...
        "taste_sort_dormant": "El ranking de gusto se está reconstruyendo — todavía no ordena",
        "taste_sort_dormant_tooltip": "El perfil de gusto se reconstruyó y los anuncios aún no se han vuelto a puntuar. Una puntuación hecha contra un perfil anterior nunca se ordena junto a una actual, así que este orden vuelve a la fecha hasta que termine.",
        ...
        "taste_retrain_button": "Reentrenar gusto",
        "taste_retrain_title": "Reconstruir el perfil de gusto desde sus comentarios y repuntuar lo obsoleto",
        "taste_retrain_confirm": "¿Reconstruir el perfil de gusto y repuntuar los anuncios visibles? Gasta crédito de suscripción (aprox. 1 llamada por cada 8 anuncios; nada de Google).",
        "taste_mode_title": "Gusto - cuánto encaja cada anuncio con el gusto del propietario",
        "taste_score_label": "Gusto",
        "taste_title": "Afinidad con el gusto del propietario",
        "taste_not_scored": "Aún sin puntuar contra el perfil de gusto.",
        "taste_stale_hint": "Puntuado contra un perfil de gusto anterior; vuelva a ejecutar el backfill para actualizarlo.",
        "taste_coverage": "Gusto: %s de %s puntuados contra el perfil v%s",
        "taste_coverage_tooltip": "El resto está sin puntuar o puntuado contra una versión anterior del perfil. Un anuncio sin puntuar no es un anuncio que no guste.",
        "taste_confidence_label": "Confianza",
        "taste_profile_version_label": "perfil",
        "taste_closest_reference": "más parecido a",
        "recommendation_profile_current": "Las recomendaciones usan %s referencias positivas y %s preferencias registradas.",
        "recommendation_profile_unapplied": "%s preferencia(s) aún no se usa(n).",
        "recommendation_hard_exclusions": "%s conflicto(s) confirmado(s) con reglas estrictas se oculta(n) en esta vista; siguen disponibles en los demás modos.",
        "recommendation_profile_dirty": "Las recomendaciones necesitan actualizarse tras sus últimos comentarios.",
        "recommendation_profile_pending": "Las recomendaciones se están preparando a partir de sus comentarios.",
        "recommendation_profile_failed": "No se pudieron actualizar las recomendaciones; la evidencia anterior puede estar desactualizada.",
        "recommendation_profile_none": "Marque una vivienda o añada un veredicto para empezar a recibir recomendaciones.",
        "recommendation_refresh_button": "Actualizar recomendaciones",
        "recommendation_refresh_title": "Reconstruir la evidencia y reordenar los anuncios preparados sin llamadas de modelo por anuncio",
        "recommendation_refresh_confirm": "¿Actualizar las recomendaciones desde sus comentarios y favoritos? Usa hasta una llamada de suscripción para el perfil; la reordenación no usa llamadas por anuncio ni Google.",
        "recommendation_reference": "Vivienda de referencia",
        "recommendation_rejected": "Rechazada — no recomendada",
        "recommendation_candidate": "Candidata",
        "recommendation_stale": "Recomendación anterior",
        "recommendation_no_profile": "Aún no hay recomendación",
        "recommendation_nearest_reference": "Referencia positiva más cercana:",
        "recommendation_reference_resemblance": "También se parece en:",
        "recommendation_conflicts_present": "Hay conflictos conocidos que requieren atención.",
        "recommendation_verification_needed": "Aún hay detalles importantes que comprobar.",
        "recommendation_mode_title": "Recomendaciones basadas en sus referencias y comentarios",
        "recommendation_sort_label": "Recomendaciones",
        "recommendation_column_label": "Afinidad",
        "recommendation_similar_to": "Similar a",
        "recommendation_details": "Detalles",
        "recommendation_matches": "Preferencias coincidentes",
        "recommendation_check_count": "Temas por comprobar: %s",
        "recommendation_conflict_count": "Conflictos: %s",
        "recommendation_photo_count": "Semejanzas en fotos: %s",
        "recommendation_aspect_plot_outline": "forma de la parcela",
        "recommendation_aspect_plot_area_m2": "tamaño de la parcela",
        "recommendation_aspect_planning_usability": "situación legal y viabilidad de obras",
        "recommendation_aspect_utilities": "suministros",
        "recommendation_aspect_beach_access": "acceso a la playa",
        "recommendation_aspect_fiber": "fibra óptica",
        "recommendation_aspect_price_value": "precio respecto al mercado",
        "recommendation_aspect_sea_view": "vistas al mar",
        "recommendation_aspect_house_condition": "estado de la casa",
        "recommendation_aspect_area_consistency": "registros de superficie",
        "recommendation_aspect_neighbor_privacy": "privacidad y vecinos",
        "recommendation_aspect_nearby_buildings": "edificaciones cercanas",
        "recommendation_aspect_agricultural_context": "entorno agrícola",
        "recommendation_aspect_road_proximity": "cercanía a la carretera",
        "recommendation_aspect_house_character": "carácter de la casa",
        "recommendation_aspect_room_scale": "tamaño de las habitaciones",
        "recommendation_aspect_land_presence": "terreno junto a la casa",
        "recommendation_aspect_visual_appeal": "aspecto exterior",
        "recommendation_aspect_property_kind": "tipo de inmueble",
        "recommendation_aspect_budget_condition": "condición de precio y estado",
        "similar_filter": "Parecidos a los favoritos",
        "similar_any": "Parecidos a ★: todos",
        "similar_80": "Parecidos a ★: ≥ 80",
        "similar_70": "Parecidos a ★: ≥ 70",
        "similar_60": "Parecidos a ★: ≥ 60",
        "similarity_sort_label": "Parecido a los favoritos",
        "similar_coverage": "Parecidos: %s con ≥ %s respecto a",
        "similarity_references_one": "%s favorito",
        "similarity_references_other": "%s favoritos",
        "similarity_references_each": "los favoritos propios de cada suscripción (%s en total)",
        "similarity_to_favorites_basis": "la ubicación del favorito desde",
        "similar_set_aside": "— %s rechazados por usted, apartados",
        "similar_hidden_by_favorites": "— ocultos por el interruptor de Favoritos",
        "similar_rankable": "Parecidos: %s de %s clasificables respecto a",
        "similar_no_reference_hint": "Esta suscripción aún no tiene favoritos, así que este corte no conserva nada",
        "similarity_counts_line": "%s no se pueden situar · %s de otro tipo · %s sin favorito con qué comparar · %s rechazados por usted · %s de los clasificables se apoyan solo en precio, superficie y ubicación · parcela comparada en %s.",
        "similarity_facts_short": "%s de %s datos",
        "similar_coverage_tooltip": "Un parecido ponderado, sobre los datos que ambos anuncios indican — precio, superficie construida, ubicación, parcela, dormitorios, baños, distancia al mar, vistas al mar — con el favorito más cercano de la misma suscripción. Los favoritos siempre los conserva el corte. Un anuncio que no se puede situar en el mapa nunca cuenta como parecido.",
        "similarity_chip_title": "Parecido %s con el favorito #%s, sobre: %s",
        "similarity_thin_hint": "Sin clasificar: este anuncio no se puede situar (sin coordenada y sin anuncios situados en su municipio), así que el número se apoya solo en %s",
        "similarity_title": "Parecido a los favoritos",
        "similarity_reference": "Este anuncio es uno de los favoritos de la suscripción; los demás se miden contra él.",
        "similarity_nearest": "favorito más cercano",
        "similarity_compared_on": "comparado sobre",
        "similarity_location_basis": "ubicación desde",
        "similarity_basis_coordinate": "la coordenada propia del anuncio",
        "similarity_basis_approximate": "la coordenada aproximada del anuncio (un pin o el centroide de la localidad)",
        "similarity_basis_municipality": "los anuncios situados del municipio",
        "similarity_basis_municipality_n": "los anuncios situados del municipio (%s)",
        "similarity_not_ranked_thin": "Sin clasificar: el anuncio no se puede situar en el mapa, y un parecido necesita una ubicación.",
        "similarity_different_kind": "Sin comparar: es un tipo de anuncio distinto de los favoritos de la suscripción.",
        "similarity_no_reference": "Nada con qué comparar: esta suscripción aún no tiene favoritos.",
        "similarity_rejected": "Usted rechazó este anuncio, así que queda fuera de la selección de parecidos — la puntuación de abajo es la que habría tenido.",
        "similarity_nothing_compared": "Nada que comparar: el anuncio y los favoritos no indican ningún dato en común.",
        "similarity_see_list": "Ver los anuncios más parecidos a los favoritos",
        "similarity_component_price": "precio",
        "similarity_component_area": "superficie construida",
        "similarity_component_geography": "ubicación",
        "similarity_component_plot": "parcela",
        "similarity_component_bedrooms": "dormitorios",
        "similarity_component_bathrooms": "baños",
        "similarity_component_sea_distance": "distancia al mar",
        "similarity_component_sea_view": "vistas al mar",
