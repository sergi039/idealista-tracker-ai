...
TRANSLATIONS = {
    "en": {
        ...
        "similarity_counts_line": "%s cannot be placed · %s of a different kind · %s with no favorite to compare to · %s you rejected, set aside · %s of the rankable rest on price, area and location alone · plot compared on %s.",
    ...
    "es": {
        ...
        "similarity_counts_line": "%s no se pueden situar · %s de otro tipo · %s sin favorito con qué comparar · %s rechazados por usted, apartados · %s de los clasificables se apoyan solo en precio, superficie y ubicación · parcela comparada en %s.",
