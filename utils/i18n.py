...
TRANSLATIONS = {
    "en": {
        ...
        "hazards_coverage": "Industrial neighbours: %s of %s listings fully scanned",
        "hazards_coverage_tooltip": "The rest were never scanned, or their scan came back incomplete. A listing with no scan is not a listing with nothing near it.",
    ...
    "es": {
        ...
        "hazards_coverage": "Vecindad industrial: %s de %s anuncios explorados por completo",
        "hazards_coverage_tooltip": "El resto nunca se exploró, o su exploración quedó incompleta. Un anuncio sin exploración no es un anuncio sin nada cerca.",
