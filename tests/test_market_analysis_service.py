...
class TestMarketAnalysisService:
    ...
    def test_rental_adjustments_exist(self, market_service):
        ...
        assert (
            market_service.RENTAL_ADJUSTMENTS["urban"]["vacancy_rate"]
            < market_service.RENTAL_ADJUSTMENTS["rural"]["vacancy_rate"]
        )

    def test_calculate_construction_value_includes_purchase_costs(
    ...
    def test_calculate_construction_value_2025_costs(
        self, app, market_service, test_land
    ):
