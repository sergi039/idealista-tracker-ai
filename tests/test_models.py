...
class TestLandModel:
    ...
    def test_land_type_constraint(self, app):
        ...
        with app.app_context():
            ...
            land1 = Land(source_email_id="test_email_dev", land_type="developed")
            land2 = Land(source_email_id="test_email_build", land_type="buildable")
    ...
    def test_unique_source_email_id(self, app):
        ...
        with app.app_context():
            land1 = Land(source_email_id="duplicate_email", title="First Land")
            land2 = Land(source_email_id="duplicate_email", title="Second Land")
...
class TestScoringCriteriaModel:
    ...
    def test_criteria_repr(self, app):
        ...
        with app.app_context():
            criteria = ScoringCriteria(
                criteria_name="transport", weight=Decimal("0.15")
            )
