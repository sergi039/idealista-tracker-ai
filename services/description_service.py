...
class DescriptionService:
    ...
    def enhance_description(
        self, raw_description: str, property_data: Dict[str, Any] = None
    ) -> Dict[str, Any]:
        """
        ...
        try:
            if not raw_description.strip():
                return {
                    "enhanced_description": "No description available",
                    "language": "en",
                }
...
IMPORTANT: Create equivalent professional content in both languages - don't just translate word for word, but convey the same professional marketing message in both English and Spanish."""
            ...
            try:
                ...
                if (
                    "enhanced_description_en" in enhanced_data
                    and "enhanced_description_es" in enhanced_data
                ):
                    # New bilingual format
                    enhanced_data["enhanced"] = enhanced_data[
                        "enhanced_description_en"
                    ]  # Default to English
                    enhanced_data["enhanced_en"] = enhanced_data[
                        "enhanced_description_en"
                    ]
                    enhanced_data["enhanced_es"] = enhanced_data[
                        "enhanced_description_es"
                    ]
                    ...
                    ]  # SAME content for both languages
    ...
    def _create_fallback_description(
        self, raw_description: str, extracted_data: Dict
    ) -> str:
        """
        ...
        try:
            ...
            if hasattr(land, "enhanced_description") and land.enhanced_description:
                try:
                    ...
                    return {
                        "enhanced": enhanced_data.get(
                            "enhanced_en",
                            enhanced_data.get("enhanced_description", land.description),
                        ),
                        "enhanced_en": enhanced_data.get(
                            "enhanced_en",
                            enhanced_data.get("enhanced_description", land.description),
                        ),
                        "enhanced_es": enhanced_data.get(
                            "enhanced_es",
                            enhanced_data.get(
                                "enhanced_en",
                                enhanced_data.get(
                                    "enhanced_description", land.description
                                ),
                            ),
                        ),  # SAME as English if Spanish missing
                        "original": enhanced_data.get(
                    ...
                    logger.warning(
                        f"Failed to parse enhanced description for land {land_id}: {e}"
                    )
                    pass
